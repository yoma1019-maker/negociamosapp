...
// Devuelve string con formato COP: "$ 34.173.500,00"
        ...
        [
            ...
            if (!el) return;
            el.addEventListener("input", actualizarAgentes);
    ...
    if (agente1 === "") {
        ...
        return false;
            ...
            // Actualiza fechas automáticas de cuotas restantes (respetando modificaciones manuales)
                    function actualizarFechasAutomaticas() {
                        ...
                        for (let i = 1; i < fechaCuotasRestantesInputs.length; i++) {
                            ...
                            if (fechasModificadas[i]) continue; // ⚠️ no sobrescribir fecha editada manualmente
                ...
                // actualizar valor de las cuotas restantes
                ...
                // Actualiza las fechas de las cuotas teniendo en cuenta la primera fecha y el número de cuotas
                // Modificación de actualizarFechasCuotas para que respete edición manual
                    function actualizarFechasCuotas() {
                        ...
                        if (!fecha1 || numCuotas <= 0) {
                            [fecha2Input, fecha3Input, fecha4Input].forEach(f => { if(f) f.value = ""; });
                            return;
                        }
                        ...
                        // Reaplicar extraordinarias
                        aplicarCuotasExtraordinarias();
                    }
            ...
            // Actualizar cuotas restantes considerando extraordinarias y fechas modificadas
                ...
                if (valorMenosCuotaInput) valorMenosCuotaInput.addEventListener("input", aplicarCuotasExtraordinarias);
                ...
                // ====== Evento Submit (Enviar formulario) ======
                    ...
                    // recalculo avanzado de cuotas restantes con personalización
                        ...
                        // ====================================
                        // FUNCIÓN PRINCIPAL: Recalcular Cuotas
                        // ====================================
